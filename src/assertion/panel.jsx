...
const r = /dweb:\/ipns\/[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{46}/
...
class SignatureView extends React.Component {
	constructor(props) {
		...
		const signatures = getSignatures(flattened)
		const nonSignatures = getNonSignatures(flattened)
		this.state = {
			bytes: null,
			verified: null,
			signatures,
